...
def cmd_predict(args) -> int:
    raise NotImplementedError("SHM predict CLI not written yet")
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="SHM subsystem: Regression -- cumulative fatigue damage estimation.")
    ...
    p.add_argument("--output", type=Path, default=HERE / "output" / "shm_predictions.csv")
