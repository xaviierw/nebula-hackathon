"""Feature extraction for Rail Corrugation.
...
def extract(frame: pd.DataFrame) -> dict:
    ...
    raise NotImplementedError("Rail Corrugation feature extraction not written yet")


def build_table(frames: dict) -> pd.DataFrame:
    """Many files -> a feature table, one row per file."""
    raise NotImplementedError("Rail Corrugation feature table not written yet")
