...
import { MAX_RAIL_FILE_BYTES } from '../workspace'
  ...
  return (
    <div>
      <button type="button" disabled={disabled} onClick={() => inputRef.current?.click()}
        ...
        <span className="mt-1 block text-xs text-slate-500">or click to browse · CSV files · up to {MAX_RAIL_FILE_BYTES / 1024 / 1024} MiB each</span>
      </button>
